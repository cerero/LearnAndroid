...
#include "dm01/Square.h"
#include "dm01/Triangle.h"
...
void TwoDG1::OnLoad(JNIEnv* env, void* reserved)
{
	...
	jclass cls = env->FindClass("com/example/videodecoderandrender/demo/chap04/dm01/MyRenderer");
