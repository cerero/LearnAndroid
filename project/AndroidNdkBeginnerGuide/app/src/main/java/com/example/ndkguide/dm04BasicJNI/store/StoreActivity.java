...
import com.example.ndkguide.dm04BasicJNI.exception.StoreFullException;
...
public class StoreActivity extends Activity {
    ...
    public static class PlaceholderFragment extends Fragment implements StoreListener {
        private StoreThreadSafe mStore = new StoreThreadSafe(this);
        private long mWather;
        ...
        public void onResume() {
            super.onResume();
            mWather = mStore.startWatcher();
        }

        @Override
        public void onPause() {
            super.onPause();
            mStore.stopWatcher(mWather);
        }
