...
import com.example.ndkguide.dm04BasicJNI.exception.InvalidTypeException;
import com.example.ndkguide.dm04BasicJNI.exception.NotExistingKeyException;
...
public class StoreThreadSafe extends Store {
    ...
    @Override
    public byte getByte(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK) {
    ...
    @Override
    public char getChar(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK) {
    ...
    @Override
    public double getDouble(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public float getFloat(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public long getLong(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public short getShort(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public boolean[] getBooleanArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public byte[] getByteArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public char[] getCharArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public double[] getDoubleArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public float[] getFloatArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public long[] getLongArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
    ...
    @Override
    public short[] getShortArray(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK){
