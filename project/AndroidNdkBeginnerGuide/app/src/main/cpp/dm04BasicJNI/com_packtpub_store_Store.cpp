...
static jmethodID MethodSuccessInt;
static jmethodID MethodSuccessString;
static jmethodID MethodSuccessColor;

static jobject gLock;

extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM* pVM, void* reserved) {
    JNIEnv *env;
    ...
    jclass ColorClassTmp = env->FindClass("com/example/ndkguide/dm04BasicJNI/store/Color");
    if (ColorClassTmp == NULL) abort();
    ColorClass = (jclass) env->NewGlobalRef(ColorClassTmp);
    env->DeleteLocalRef(ColorClassTmp);

    jclass StoreClassTmp = env->FindClass("com/example/ndkguide/dm04BasicJNI/store/Store");
    MethodSuccessInt = env->GetMethodID(StoreClassTmp, "onSuccess", "(I)V");
    if (MethodSuccessInt == NULL) abort();

    MethodSuccessString = env->GetMethodID(StoreClassTmp, "onSuccess", "(Ljava/lang/String;)V");
    if (MethodSuccessString == NULL) abort();

    MethodSuccessColor = env->GetMethodID(StoreClassTmp, "onSuccess", "(Lcom/example/ndkguide/dm04BasicJNI/store/Color;)V");
    if (MethodSuccessColor == NULL) abort();

    env->DeleteLocalRef(StoreClassTmp);
    ...
    jmethodID ObjectConstrutor = env->GetMethodID(ObjectClass, "<init>", "()V");
    if (ObjectConstrutor == NULL) abort();

    jobject lockTmp = env->NewObject(ObjectClass, ObjectConstrutor);
    gLock = env->NewGlobalRef(lockTmp);

    env->DeleteLocalRef(ObjectClass);
    env->DeleteLocalRef(lockTmp);

    jclass StoreThreadSafeClass = env->FindClass("com/example/ndkguide/dm04BasicJNI/store/StoreThreadSafe");
...
extern "C" JNIEXPORT jint JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getCount
  (JNIEnv* pEnv, jobject pObject) {
    return gStore.mLength;
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getBoolean
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setBoolean
...
extern "C" JNIEXPORT jbyte JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getByte
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setByte
...
extern "C" JNIEXPORT jchar JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getChar
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setChar
...
extern "C" JNIEXPORT jdouble JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getDouble
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setDouble
...
extern "C" JNIEXPORT jfloat JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getFloat
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setFloat
...
extern "C" JNIEXPORT jint JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getInteger
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setInteger
  (JNIEnv* pEnv, jobject pThis, jstring pKey, jint pInteger) {
    StoreEntry* entry = allocateEntry(pEnv, &gStore, pKey);
    if (entry != NULL) {
        entry->mType = StoreType_Integer;
        entry->mValue.mInteger = pInteger;
        pEnv->CallVoidMethod(pThis, MethodSuccessInt, (jint)entry->mValue.mInteger);
    }
}

extern "C" JNIEXPORT jlong JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getLong
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setLong
...
extern "C" JNIEXPORT jshort JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getShort
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setShort
...
extern "C" JNIEXPORT jstring JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getString
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setString
  (JNIEnv* pEnv, jobject pThis, jstring pKey, jstring pString) {
    ...
    if (entry != NULL) {
        ...
        pEnv->CallVoidMethod(pThis, MethodSuccessString, pEnv->NewStringUTF(entry->mValue.mString));
    }
}

extern "C" JNIEXPORT jobject JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getColor
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setColor
  (JNIEnv* pEnv, jobject pThis, jstring pKey, jobject pColor) {
    ...
    if (entry != NULL) {
        ...
        pEnv->CallVoidMethod(pThis, MethodSuccessColor, entry->mValue.mColor);
    }
}

extern "C" JNIEXPORT jbooleanArray JNICALL
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getBooleanArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setBooleanArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getByteArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setByteArray
...
extern "C" JNIEXPORT jcharArray JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_getCharArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setCharArray
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getDoubleArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setDoubleArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getFloatArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setFloatArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getIntegerArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setIntegerArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getLongArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setLongArray
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getShortArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setShortArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getStringArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setStringArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_ndkguide_dm04BasicJNI_store_Store_getColorArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey) {
    StoreEntry* entry = findEntry(pEnv, &gStore, pKey);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_ndkguide_dm04BasicJNI_store_Store_setColorArray
  (JNIEnv* pEnv, jobject pThis, jstring pKey,
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_startWatcher(JNIEnv* pEnv, jobject pThis) {
    JavaVM* javaVM;
...
Java_com_example_ndkguide_dm04BasicJNI_store_Store_stopWatcher(JNIEnv* pEnv, jobject pThis, jlong pPointer) {
