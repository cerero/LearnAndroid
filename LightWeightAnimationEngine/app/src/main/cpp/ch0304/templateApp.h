...
void templateAppExit( void );
		...
		extern "C"
		{
//			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_GL2View_Init( JNIEnv *env, jclass obj, jint width, jint height, jstring apkFilePath );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_GL2View_Draw( JNIEnv *env, jclass obj );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_GL2View_ToucheBegan( JNIEnv *env, jclass obj, jfloat x, jfloat y, jint tap_count );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_GL2View_ToucheMoved( JNIEnv *env, jclass obj, jfloat x, jfloat y, jint tap_count );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_GL2View_ToucheEnded( JNIEnv *env, jclass obj, jfloat x, jfloat y, jint tap_count );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_templateApp_Accelerometer( JNIEnv *env, jclass obj, jfloat x, jfloat y, jfloat z );
//
			JNIEXPORT void JNICALL Java_com_android_templateApp_ch0304_GL2View_Init( JNIEnv *env, jclass obj, jint width, jint height, jstring apkFilePath )
            {
