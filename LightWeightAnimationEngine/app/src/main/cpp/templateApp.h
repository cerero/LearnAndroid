...
void templateAppExit( void );
		...
		extern "C"
		{
//			JNIEXPORT void JNICALL Java_com_android_templateApp_GL2View_Init( JNIEnv *env, jclass cls, jint width, jint height, jstring apkFilePath );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_GL2View_Draw( JNIEnv *env, jclass cls );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_GL2View_ToucheBegan( JNIEnv *env, jclass cls, jfloat x, jfloat y, jint tap_count );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_GL2View_ToucheMoved( JNIEnv *env, jclass cls, jfloat x, jfloat y, jint tap_count );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_GL2View_ToucheEnded( JNIEnv *env, jclass cls, jfloat x, jfloat y, jint tap_count );
//
//			JNIEXPORT void JNICALL Java_com_android_templateApp_templateApp_Accelerometer( JNIEnv *env, jclass cls, jfloat x, jfloat y, jfloat z );
//
